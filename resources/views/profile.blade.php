    ...
    <div class="flex items-center justify-center mt-10">
        <div class="max-w-md w-full bg-white shadow-md rounded-lg p-6">
            ...
            <div class="flex justify-center mb-4">
                <img src="{{ $profile && $profile->profile_picture ? asset('storage/' . $profile->profile_picture) : asset('images/default-avatar.png') }}"
                    alt="Profile Picture" class="h-24 w-24 rounded-full object-cover border-2 border-blue-500">
            </div>
